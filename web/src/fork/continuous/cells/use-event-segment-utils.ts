/**
 * fork/continuous/cells — COPIED from upstream `web/src/hooks/use-event-segment-utils.ts`
 * upstream tag: 0.17.1 (fork base 0.17.1-troy.10)   sha256 at copy: 99fc3ebecaac9d8948682195c947245b9a51ca74719a66aad3fe6ea7e22899bd
 *
